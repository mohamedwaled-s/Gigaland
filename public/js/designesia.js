...
(function ($) {
  ...
  function dark_scheme() {
    ...
    $(".wallet").css("backgroundColor", "");
    $(".wallet").css("border", "");
    $(".item").css("backgroundColor", "");
    $(".item").css("border", "");
    $(".accordion-item").css("background", "#21273e");
    $(".accordion-button").css("backgroundColor", "#21273e");
    $(".accordion-button").css("color", "#fff");
    $("table").addClass("table-dark");
    $("th").css("backgroundColor", "#21273e");
    $("td").css("backgroundColor", "#21273e");
  ...
  function light_scheme() {
    ...
    $(".wallet").css("backgroundColor", "#fff");
    $(".wallet").css("border", "1px solid #eee");
    $(".item").css("backgroundColor", "#fff");
    $(".item").css("border", "1px solid #eee");
    $(".accordion-item").css("background", "");
    $(".accordion-button").css("backgroundColor", "");
    $(".accordion-button").css("color", "");
  ...
  function custom_bg() {
    ...
    $("body.dark-scheme,.dark-scheme div,.dark-scheme section").css(
      "background",
      function () {
